...
public class VoyageController {
    ...
    public GenericResponse<BigDecimal> getTotalEarningsOfVoyage(@PathVariable Long id) {
        LoggerHandler.getLogger().log(Level.INFO,
                "VoyageController -->getTotalEarningsOfVoyage()--> voyage ID has been sent to VoyageService getTotalEarninsgOfVoyage().");

        return GenericResponse.success(voyageService.getTotalEarningsOfVoyage(id), HttpStatus.OK);
    }
