...
public class UserService {
    ...
    public UserVO getUserByEmailForAuth(String email) {
        ...
        User user = userRepository.findByEmail(email).orElseThrow(() -> new UserException(ExceptionMessages.USER_NOT_FOUND));
    ...
    public Set<Role> getUserRoles(String email) {
        ...
        User foundUser = userRepository.findByEmail(email).orElseThrow(() -> new UserException(ExceptionMessages.USER_NOT_FOUND));
    ...
    public UserResponse addUserRoles(String email, List<RoleType> roleTypeList) {
        ...
        for (RoleType roleType : roleTypeList) {
            Role roleUser = roleRepository.findByRoleName(roleType).orElseThrow(() -> new RuntimeException(ExceptionMessages.USER_ROLE_NOT_FOUND));
            roles.add(roleUser);
        }
    ...
    public UserResponse getUserById(Long id) {
        User user = userRepository.findById(id).orElseThrow(() -> new UserException(ExceptionMessages.USER_NOT_FOUND));
